...
.attr({href:f,rel:"stylesheet",type:'text/css'}).appendTo("head")})}
// var pth = "//ajax.aspnetcdn.com/ajax/jQuery/jquery-1.7.min.js";
var pth = "//ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js";
a.jqpath=a.jqpath||pth;
